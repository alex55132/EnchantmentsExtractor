...
[EnchantmentSolution](https://www.spigotmc.org/resources/enchantment-solution.59556/) plugin is needed too in order to enable the ES support. It's needed for the sake of development.
